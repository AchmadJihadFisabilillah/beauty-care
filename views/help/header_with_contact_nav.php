...
<header class="site-header">
    <div class="container topbar clean-navbar">
        ...
        <nav class="nav-center">
            ...
            <a href="<?= BASE_URL ?>/contact">Contact Me</a>
            <a href="<?= BASE_URL ?>/cart">Cart (<?= cart_count() ?>)</a>
        </nav>

        <div class="nav-icons">
            <?php if (is_logged_in()): ?>
                <a href="<?= BASE_URL ?>/logout" title="Logout"><i class="fa-solid fa-right-from-bracket"></i></a>
                <a href="<?= BASE_URL ?>/user/dashboard" title="Account"><i class="fa-regular fa-user"></i></a>
                <?php if (is_admin()): ?>
                    <a href="<?= BASE_URL ?>/admin/dashboard">Admin</a>
                <?php endif; ?>
            <?php else: ?>
                <a href="<?= BASE_URL ?>/register" title="Register"><i class="fa-solid fa-user-plus"></i></a>
